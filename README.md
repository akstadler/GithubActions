[![Run App Stadler, Alexander](https://github.com/akstadler/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/akstadler/GithubActions/actions/workflows/ci.yml)
